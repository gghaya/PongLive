        ...
        switch (data.type) {
          case 'friends-add':
            ...
            handleNewNotification({
              ...
              type: 'friend_request',
              avatar: data.user.image_field ? `https://${HOST}/api/api${data.user.image_field}` : '/images/Default_profile.png',
        ...
        <div ref={userDropdownRef}>
          ...
          >
            ...
            <img
              ...
              src={userData?.image_field ? `https://${HOST}/api/api${userData.image_field}` : "/images/DefaultAvatar.svg"}
              alt="User dropdown"
              width={100}
              height={100}
              /> 
