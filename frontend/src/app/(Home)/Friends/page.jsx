...
export default function Friends() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const friendsList = await customAxios.get(`https://${HOST}/api/friend/friends`);
        const FriendRes = await customAxios.get(`https://${HOST}/api/friend/friend-request/`);
        const blockedRes = await customAxios.get(`https://${HOST}/api/friend/blocked-friends/`);
