    ...
    const fetchAllMatches = async () => {
      try {
        ...
        const [aiMatchesResponse, normalMatchesResponse] = await Promise.all([
          axios.get(`https://${HOST}/api/game/fetch_history/${userData.username}/`),
          axios.get(`https://${HOST}/api/game/matches/${userData.username}/`)
        ]);
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-content overflow-auto overflow-y-scroll custom-scrollbar h-[95%]">
        {!userData ? (
          <div className="flex justify-center items-center py-10 text-[#4E5981]">
