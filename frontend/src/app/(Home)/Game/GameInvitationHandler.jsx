    ...
    const handleGameInvitation = (event) => {
      ...
      const notificationEvent = new CustomEvent('newNotification', {
        detail: {
          ...
          avatar: data.sender_image ? `https://${HOST}/api/api${data.sender_image}` : "/images/DefaultAvatar.svg",
            ...
            <div className="flex items-center space-x-4">
              <div className="flex-shrink-0">
                <img
                  ...
                  src={data.sender_image ? `https://${HOST}/api/api${data.sender_image}` : "/images/DefaultAvatar.svg"}
                  alt=""
                />
              </div>
